...
const gulp = require('gulp'),
    ...
    files = [
                {name: "dist/functions.php",content: "<?php // Silence is golden... ?>"},
                {name: "dist/index.php",content: "<?php // Silence is golden... ?>"},
                {name: "dist/single.php",content: "<?php // Silence is golden... ?>"},
                {name: "dist/page.php",content: "<?php // Silence is golden... ?>"},
                {name: "dist/archive.php",content: "<?php // Silence is golden... ?>"},
                {name: "dist/category.php",content: "<?php // Silence is golden... ?>"},
                {name: "dist/search.php",content: "<?php // Silence is golden... ?>"},
                {name: "dist/header.php",content: "<?php // Silence is golden... ?>"},
                {name: "dist/footer.php",content: "<?php // Silence is golden... ?>"},
                {name: "dist/sidebar.php",content: "<?php // Silence is golden... ?>"}
            ],
...
gulp.task('vendors', function() {
  return gulp.src(['node_modules/jquery/dist/jquery.js','node_modules/owl.carousel/dist/owl.carousel.min.js','node_modules/masonry-layout/dist/masonry.pkgd.js'])
    .pipe(uglify())
